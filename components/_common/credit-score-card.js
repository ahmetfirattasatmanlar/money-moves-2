export default function CreditScoreCard({ name = "Good", interestRate = 0, monthlyPayment = 0, active = false }) {
  return (
    <div
      className={`card d-flex justify-content-center rounded-lg ${active ? 'active-card' : ''}`}
      style={{ width: "calc(33% - .5rem)" }}
    >
      <div
        className="card-body pb-0 w-100 d-flex flex-column align-items-center"
      >
