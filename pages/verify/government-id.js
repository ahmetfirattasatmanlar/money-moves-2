          ...
          <div className="px-3 pb-bottom-app">
            ...
            <div className={`slider-panel ${onSlide ? 'show' : ''}`}>
              <div className="slider-panel-dialog">
                ...
                <div className="d-flex align-items-center py-3" onClick={() => { setTakePicture(true), setOnSlide(false) }}>
      ...
      {takePicture ?
        <div className="d-flex flex-column h-100 bg-dark" >
          <div className="px-3 pb-3 text-white d-flex justify-content-between align-items-center">
            <div className="btn btn-link pl-0 " onClick={() => setTakePicture(false)}><IoIosArrowBack /></div>
          ...
          <div className="px-3 text-center py-5">
            ...
            <button className="btn btn-primary rounded-lg px-3" onClick={() => { setCheckQuality(true), setTakePicture(false) }}><FaCheck /></button>
          </div>
        </div>
        : undefined}

      {checkQuality ? <div className="d-flex flex-column h-100" >
        <div className="px-3 pb-3 text-white d-flex justify-content-between align-items-center">
          <div className="btn btn-link pl-0 " onClick={() => setCheckQuality(false)}><IoIosArrowBack /></div>
        ...
        <div className="px-3 text-center py-5">
          ...
          <div className="mt-5s">
            ...
            <button className="btn btn-light text-primary btn-block" onClick={() => { setTakePicture(true), setCheckQuality(false) }}>Take a new photo</button>
          </div>
        </div>
      </div> : undefined}
