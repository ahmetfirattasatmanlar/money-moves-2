        ...
        <AppWrapper>
            ...
            {loanState !== 0 && loanState !== 4 && loanState !== 5 ? (
                <div className="bg-white text-center d-flex mt-2 col-sm-6 py-2 shadow-lg" style={{ position: "fixed", bottom: 0, maxWidth: "26.56rem" }}>
                    ...
                    <button className="btn btn-primary rounded-lg w-100 ml-2" onClick={() => setLoanState(loanState + 1)}>
                        Next
                    </button>
                </div>
            ) : undefined}
            ...
            {loanState === 3 ? (
                <div className="bg-white text-center d-flex mt-2 col-sm-6 py-2 shadow-lg" style={{ position: "fixed", bottom: 0, maxWidth: "26.56rem" }}>
                    <button className="btn btn-primary rounded-lg w-100 mr-2" onClick={() => setLoanState(loanState + 1)}>
                        Submit
                    </button>
                </div>
            ) : undefined}
